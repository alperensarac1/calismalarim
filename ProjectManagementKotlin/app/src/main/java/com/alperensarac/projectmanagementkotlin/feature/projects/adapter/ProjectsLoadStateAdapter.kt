...
/**
 * Paging 3 footer loading ve retry durumlarını gösterir.
 */
class ProjectsLoadStateAdapter(
    private val retry: () -> Unit
) : androidx.paging.LoadStateAdapter<ProjectsLoadStateAdapter.LoadStateViewHolder>() {
    ...
    class LoadStateViewHolder(
        ...
        init {
            binding.buttonPagingRetry.setOnClickListener {
                retry()
            }
        }
