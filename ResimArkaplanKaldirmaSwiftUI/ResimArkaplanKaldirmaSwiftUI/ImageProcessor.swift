...
enum ImageProcessor {
    ...
    static func removeConnectedRegionByColor(
        ...
        func visitedIndex(x: Int, y: Int) -> Int {
            y * width + x
        }
        ...
        while !queue.isEmpty {
            ...
            let vIndex = visitedIndex(x: x, y: y)
        ...
        return UIImage(cgImage: outputCGImage, scale: source.scale, orientation: source.imageOrientation)
    }
